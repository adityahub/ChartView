...
public struct ChartForm {
    ...
    #else
    public static let small = CGSize(width:360, height:470)
    public static let medium = CGSize(width:360, height:470)
    public static let large = CGSize(width:360, height:470)
    public static let extraLarge = CGSize(width:360, height:480)
    public static let detail = CGSize(width:360, height:470)
    #endif
